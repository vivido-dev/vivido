...
///
/// Simple selections precisely track cells without expansion, while block selections track a
/// rectangular region.
...
mod tests {
    ...
    fn range_intersection() {
        let mut selection =
            Selection::new(SelectionType::Simple, Point::new(Line(3), Column(1)), Side::Left);
