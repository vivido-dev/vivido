...
use vivido_terminal::term::{LineDamageBounds, TermDamageIterator};
...
/// Iterator which converts `vivido_terminal` damage information into renderer damaged rects.
...
mod tests {
    ...
    fn add_viewport_damage() {
        ...
        assert_eq!(
            ...
            DamageRect { x, y: viewport_height as i32 - y - height, width, height }
        );
