...
use vivido_terminal::grid::{BidirectionalIterator, Dimensions};
use vivido_terminal::index::{Boundary, Column, Direction, Line, Point};
use vivido_terminal::term::cell::Hyperlink;
use vivido_terminal::term::search::{Match, RegexIter, RegexSearch};
use vivido_terminal::term::{Term, TermMode};
...
#[cfg(test)]
mod tests {
    use vivido_terminal::index::{Column, Line};
    use vivido_terminal::term::test::mock_term;
    use vivido_terminal::vte::ansi::Handler;
