...
use vivido_terminal::event::EventListener;
use vivido_terminal::grid::{Dimensions, Scroll};
use vivido_terminal::index::{Column, Direction, Point, Side};
use vivido_terminal::selection::SelectionType;
use vivido_terminal::term::{ClipboardType, Term, TermMode};
use vivido_terminal::vte::ansi::{ClearMode, Handler};

use crate::clipboard::Clipboard;
#[cfg(target_os = "macos")]
use crate::config::window::Decorations;
use crate::config::{Action, BindingMode, MouseEvent, SearchAction, UiConfig};
        ...
        match self {
            ...
            | Action::ScrollHalfPageDown => {
                ...
                let scroll = match self {
                    ...
                    Action::ScrollHalfPageUp => Scroll::Delta(term.screen_lines() as i32 / 2),
                    Action::ScrollHalfPageDown => Scroll::Delta(-(term.screen_lines() as i32 / 2)),
                    _ => unreachable!(),
                };
                ctx.scroll(scroll);
            },
