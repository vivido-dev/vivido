...
use vivido_terminal::tty::Options as PtyOptions;
...
pub struct Options {
    ...
    /// Specify alternative configuration file [default: %APPDATA%\vivido\vivido.toml].
    #[cfg(windows)]
    #[clap(long, value_hint = ValueHint::FilePath)]
    pub config_file: Option<PathBuf>,

    /// Specify alternative configuration file [default: $HOME/.config/vivido/vivido.toml].
    #[cfg(target_os = "macos")]
    #[clap(long, value_hint = ValueHint::FilePath)]
    pub config_file: Option<PathBuf>,
