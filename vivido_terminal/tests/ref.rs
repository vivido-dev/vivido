...
use vivido_terminal::event::{Event, EventListener};
use vivido_terminal::grid::{Dimensions, Grid};
use vivido_terminal::index::{Column, Line};
use vivido_terminal::term::cell::Cell;
use vivido_terminal::term::test::TermSize;
use vivido_terminal::term::{Config, Term};
use vivido_terminal::vte::ansi;
...
fn ref_test(dir: &Path) {
    let recording = read_u8(dir.join("vivido.recording"));
