...
function __fish_vivido_global_optspecs
	string join \n print-events ref-test config-file= s/socket= headless session= foreground headless-size= q v daemon vivid-target= w/window-id= working-directory= hold e/command= T/title= class= o/option= h/help V/version
end
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window quit config get-config typing get-text screenshot capabilities key paste mouse resize focus signal list-windows inspect get-grid wait transcript subscribe help" -f -a "get-text" -d 'Read terminal text'
...
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list kill-session help" -f -a "msg" -d 'Send a message to the Vivido socket'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list kill-session help" -f -a "list" -d 'List running headless sessions'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list kill-session help" -f -a "kill-session" -d 'Shut down a headless session'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list kill-session help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
