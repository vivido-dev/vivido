...
function __fish_vivido_global_optspecs
    string join \n print-events ref-test config-file= s/socket= headless session= automation-name= foreground ephemeral headless-size= q v daemon vivid-target= w/window-id= no-activate working-directory= hold e/command= T/title= class= o/option= h/help V/version
end
...
complete -c vivido -n "__fish_vivido_needs_command" -l ephemeral -d 'Tear the headless session down when its launcher is gone or its last IPC client disconnects, so background test runs never leak sessions. Requires `--headless`'
...
complete -c vivido -n "__fish_vivido_needs_command" -f -a "test" -d 'Run an automation plan inside an ephemeral headless session, then tear it down'
complete -c vivido -n "__fish_vivido_needs_command" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -s s -l socket -d 'IPC endpoint override (a filesystem path on Unix, a named-pipe path on Windows)' -r -F
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -s t -l target -d 'Name of the session to talk to [default: $VIVIDO_SESSION or $VIVIDA_TARGET, else the only session]' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -s h -l help -d 'Print help'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -f -a "create-window" -d 'Create a new window in the same Vivido process'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -f -a "close-window" -d 'Close one window, terminating its terminal without stopping the instance'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -f -a "quit" -d 'Shut down the Vivido instance, closing every window'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -f -a "ping" -d 'Check IPC liveness'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -f -a "reset-terminal" -d 'Reset parser and client-controlled terminal state for one window'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -f -a "restart-terminal" -d 'Replace one terminal process while preserving its stable window identity'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -f -a "find-text" -d 'Find pattern matches with cell and pixel rectangles'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -f -a "exec" -d 'Run one shell command in a window\'s working directory and report its result'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window close-window quit ping reset-terminal restart-terminal config get-config typing get-text find-text exec screenshot capabilities run-plan capture key paste drop-file mouse resize set-geometry set-visible set-level focus signal list-windows inspect diagnose vivid get-grid wait transcript subscribe help" -f -a "drop-file" -d 'Copy a local file to the remote receiver bound to a window, as a drag would'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from close-window" -s w -l window-id -d 'Window ID. The focused window is used when this is omitted' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from close-window" -s f -l force -d 'Kill the child process group first, for children that ignore hangup'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from close-window" -s h -l help -d 'Print help'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from reset-terminal" -s w -l window-id -d 'Window ID. The focused window is used when this is omitted' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from reset-terminal" -s h -l help -d 'Print help'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from restart-terminal" -s w -l window-id -d 'Window ID. The focused window is used when this is omitted' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from restart-terminal" -s h -l help -d 'Print help'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from find-text" -l pattern -d 'Literal text (or regular expression with `--regex`) to locate on the visible viewport' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from find-text" -s w -l window-id -d 'Window ID to search. Every window is searched when omitted' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from find-text" -l max-matches -d 'Maximum matches returned per window, 1 through 100' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from find-text" -l regex -d 'Treat the pattern as a regular expression instead of literal text'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from find-text" -s h -l help -d 'Print help'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from exec" -l command -d 'Shell command to run in the target window\'s working directory' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from exec" -s w -l window-id -d 'Window whose working directory scopes the command' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from exec" -l timeout -d 'Maximum wait for completion' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from exec" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from run-plan" -l report -d 'Report format. JUnit and SARIF always write `--output` and keep the NDJSON events on stdout' -r -f -a "ndjson\t'NDJSON step events on stdout (the historical output)'
junit\t'JUnit XML suite written to `--output`, in addition to the NDJSON events'
sarif\t'SARIF 2.1.0 log written to `--output`, in addition to the NDJSON events'"
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from run-plan" -l output -d 'Destination file for `--report junit` or `--report sarif`' -r -F
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from run-plan" -l set -d 'Set a plan variable, overriding the plan\'s `vars`. Repeatable as `--set KEY=VALUE`' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from run-plan" -l on-failure-dump -d 'Write a diagnostic bundle per failed step (frame.png, grid.json, transcript.bin, presenter_trace.json, metadata.json). Secrets are masked in text artifacts; pixel data in frame.png is not' -r -f -a "(__fish_complete_directories)"
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from run-plan" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from drop-file" -l at -d 'Drop onto the surface at this cell, `COLUMN,ROW`, for a receiver bound to one surface (a remote desktop, say). Without it the window\'s whole-window binding receives the file' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from drop-file" -l timeout -d 'How long to wait for the receiver\'s result (for example 30s or 10m)' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from drop-file" -s w -l window-id -d 'Window ID. The focused window is used when this is omitted' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from drop-file" -l type-path -d 'Type the committed remote path into the terminal afterwards, exactly as a drag would. Off by default: the typed text lands in whatever has focus'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from drop-file" -s h -l help -d 'Print help (see more with \'--help\')'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from wait" -f -a "prompt" -d 'Block until the shell sits at a prompt. Requires OSC 133 shell integration; a shell that never emits markers never resolves this wait'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from wait" -f -a "command-finish" -d 'Block until the running command finishes, reporting its exit code. Resolves on the next finish after registration, never on a command that already finished'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "close-window" -d 'Close one window, terminating its terminal without stopping the instance'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "reset-terminal" -d 'Reset parser and client-controlled terminal state for one window'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "restart-terminal" -d 'Replace one terminal process while preserving its stable window identity'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "find-text" -d 'Find pattern matches with cell and pixel rectangles'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "exec" -d 'Run one shell command in a window\'s working directory and report its result'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "drop-file" -d 'Copy a local file to the remote receiver bound to a window, as a drag would'
...
complete -c vivido -n "__fish_vivido_using_subcommand test" -l file -d 'JSON plan file, using the `run-plan` schema. Omit this option or pass `-` for stdin' -r -F
complete -c vivido -n "__fish_vivido_using_subcommand test" -l session -d 'Session name. Must not already exist; defaults to `vivido-test-<pid>`' -r
complete -c vivido -n "__fish_vivido_using_subcommand test" -l headless-size -d 'Size of the session window, as COLUMNSxLINES or WIDTHxHEIGHTpx' -r
complete -c vivido -n "__fish_vivido_using_subcommand test" -l report -d 'Report format, as in `run-plan`. JUnit and SARIF always write `--output` too' -r -f -a "ndjson\t'NDJSON step events on stdout (the historical output)'
junit\t'JUnit XML suite written to `--output`, in addition to the NDJSON events'
sarif\t'SARIF 2.1.0 log written to `--output`, in addition to the NDJSON events'"
complete -c vivido -n "__fish_vivido_using_subcommand test" -l output -d 'Destination file for `--report junit` or `--report sarif`' -r -F
complete -c vivido -n "__fish_vivido_using_subcommand test" -l artifacts-dir -d 'Directory for failure captures (`<step>.grid.txt`, `<step>.screenshot.json`)' -r -f -a "(__fish_complete_directories)"
complete -c vivido -n "__fish_vivido_using_subcommand test" -l set -d 'Set a plan variable, overriding the plan\'s `vars`. Repeatable as `--set KEY=VALUE`' -r
complete -c vivido -n "__fish_vivido_using_subcommand test" -l on-failure-dump -d 'Write a diagnostic bundle per failed step (frame.png, grid.json, transcript.bin, presenter_trace.json, metadata.json). Secrets are masked in text artifacts; pixel data in frame.png is not' -r -f -a "(__fish_complete_directories)"
complete -c vivido -n "__fish_vivido_using_subcommand test" -l keep-failed -d 'Keep a failed session running and print how to reattach to it'
complete -c vivido -n "__fish_vivido_using_subcommand test" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list doctor debug-bundle kill-session test help" -f -a "msg" -d 'Send a message to the Vivido socket'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list doctor debug-bundle kill-session test help" -f -a "list" -d 'List running headless sessions'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list doctor debug-bundle kill-session test help" -f -a "doctor" -d 'Check discovery, IPC, rendering, and presenter health'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list doctor debug-bundle kill-session test help" -f -a "debug-bundle" -d 'Write a bounded, versioned diagnostic ZIP bundle'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list doctor debug-bundle kill-session test help" -f -a "kill-session" -d 'Shut down a headless session'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list doctor debug-bundle kill-session test help" -f -a "test" -d 'Run an automation plan inside an ephemeral headless session, then tear it down'
complete -c vivido -n "__fish_vivido_using_subcommand help; and not __fish_seen_subcommand_from msg list doctor debug-bundle kill-session test help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "close-window" -d 'Close one window, terminating its terminal without stopping the instance'
...
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "reset-terminal" -d 'Reset parser and client-controlled terminal state for one window'
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "restart-terminal" -d 'Replace one terminal process while preserving its stable window identity'
...
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "find-text" -d 'Find pattern matches with cell and pixel rectangles'
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "exec" -d 'Run one shell command in a window\'s working directory and report its result'
...
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "drop-file" -d 'Copy a local file to the remote receiver bound to a window, as a drag would'
