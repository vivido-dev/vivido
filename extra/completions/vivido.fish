...
function __fish_vivido_global_optspecs
	string join \n print-events ref-test config-file= socket= q v daemon headless w/window-id= dimensions= working-directory= hold e/command= T/title= class= o/option= h/help V/version
end
...
complete -c vivido -n "__fish_vivido_needs_command" -l dimensions -d 'Initial terminal grid dimensions in columns by rows' -r
...
complete -c vivido -n "__fish_vivido_needs_command" -l headless -d 'Run terminal sessions with an offscreen renderer and no native windows'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window config get-config typing get-text screenshot capabilities key paste mouse resize focus signal list-windows inspect vivid-sources vivid-source-status vivid-scene-status vivid-milestones get-grid wait transcript subscribe help" -f -a "screenshot" -d 'Capture a terminal frame as a private PNG'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window config get-config typing get-text screenshot capabilities key paste mouse resize focus signal list-windows inspect vivid-sources vivid-source-status vivid-scene-status vivid-milestones get-grid wait transcript subscribe help" -f -a "vivid-sources" -d 'List Vivid sources owned by one terminal'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window config get-config typing get-text screenshot capabilities key paste mouse resize focus signal list-windows inspect vivid-sources vivid-source-status vivid-scene-status vivid-milestones get-grid wait transcript subscribe help" -f -a "vivid-source-status" -d 'Inspect one Vivid source'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window config get-config typing get-text screenshot capabilities key paste mouse resize focus signal list-windows inspect vivid-sources vivid-source-status vivid-scene-status vivid-milestones get-grid wait transcript subscribe help" -f -a "vivid-scene-status" -d 'Inspect the retained Vivid scene for one session'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and not __fish_seen_subcommand_from create-window config get-config typing get-text screenshot capabilities key paste mouse resize focus signal list-windows inspect vivid-sources vivid-source-status vivid-scene-status vivid-milestones get-grid wait transcript subscribe help" -f -a "vivid-milestones" -d 'Inspect presentation milestones for one Vivid source'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from create-window" -l dimensions -d 'Initial terminal grid dimensions in columns by rows' -r
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-sources" -s w -l window-id -d 'Window ID. The focused window is used when this is omitted' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-sources" -s h -l help -d 'Print help'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-source-status" -l session-id -d 'Vivid session ID' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-source-status" -l source-id -d 'Producer-owned Vivid source ID' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-source-status" -s w -l window-id -d 'Window ID. The focused window is used when this is omitted' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-source-status" -s h -l help -d 'Print help'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-scene-status" -l session-id -d 'Vivid session ID' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-scene-status" -l maximum-nodes -d 'Maximum number of nodes returned' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-scene-status" -s w -l window-id -d 'Window ID. The focused window is used when this is omitted' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-scene-status" -s h -l help -d 'Print help'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-milestones" -l session-id -d 'Vivid session ID' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-milestones" -l source-id -d 'Producer-owned Vivid source ID' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-milestones" -s w -l window-id -d 'Window ID. The focused window is used when this is omitted' -r
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from vivid-milestones" -s h -l help -d 'Print help'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from wait" -f -a "vivid-source" -d 'Wait for one Vivid source milestone'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "screenshot" -d 'Capture a terminal frame as a private PNG'
...
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "vivid-sources" -d 'List Vivid sources owned by one terminal'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "vivid-source-status" -d 'Inspect one Vivid source'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "vivid-scene-status" -d 'Inspect the retained Vivid scene for one session'
complete -c vivido -n "__fish_vivido_using_subcommand msg; and __fish_seen_subcommand_from help" -f -a "vivid-milestones" -d 'Inspect presentation milestones for one Vivid source'
...
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "screenshot" -d 'Capture a terminal frame as a private PNG'
...
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "vivid-sources" -d 'List Vivid sources owned by one terminal'
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "vivid-source-status" -d 'Inspect one Vivid source'
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "vivid-scene-status" -d 'Inspect the retained Vivid scene for one session'
complete -c vivido -n "__fish_vivido_using_subcommand help; and __fish_seen_subcommand_from msg" -f -a "vivid-milestones" -d 'Inspect presentation milestones for one Vivid source'
