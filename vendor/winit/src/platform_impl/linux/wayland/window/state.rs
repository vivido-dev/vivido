...
pub struct WindowState {
    ...
    /// Whether CSD moves must be sent during the button-press dispatch.
    immediate_csd_move: bool,
...
impl WindowState {
    ...
    pub fn new(
        ...
        Self {
            ...
            immediate_csd_move: winit_state.immediate_csd_move,
            ime_allowed: false,
    ...
    pub fn frame_click(
        ...
        match self.frame.as_mut()?.on_click(timestamp, click, pressed)? {
            ...
            FrameAction::Move if self.immediate_csd_move => self.window.move_(seat, serial),
